...
\newpage
\phantomsection
\addcontentsline{toc}{subsection}{A.2 ServalDHT - Secure DHT based Service Resolution Service}
\label{sec:servaldhtpres}
{\huge \bf \noindent A.2 ServalDHT - Secure DHT\\[0.2cm] based Service Resolution Service}
