...
\addcontentsline{toc}{section}{SERVIC-SENTRIC NETWORKING}
\newpage
...
\addcontentsline{toc}{subsection}{A. PRESENTATIONS}

\addcontentsline{toc}{subsubsection}{A.1 Serval Architecture}
...
\addcontentsline{toc}{subsection}{B. SOURCE CODE}
