...
At a ratio of 4:1, ISPs \nomenclature{ISP}{Internet Service Provider} had pointed out a basic characteristic of the Internet: \emph{as a user you are expected to consume rather than offer a service}.\\
